...
harvest_PMID_date <- function(get_PMID_Date) {
  #PMID <- unlist(PMID_form, use.names = FALSE)[205]
  #get_PMID_Date <- unlist(PMID_form, use.names = FALSE)[204:208]
...
date_to_tabgraph<- rbind(harvest_PMID_date(PMID_form_un),
                     harvest_PMID_date(PMID_form_deux),
                     harvest_PMID_date(PMID_form_trois),
                     harvest_PMID_date(PMID_form_quatre),
                     harvest_PMID_date(PMID_form_cinq))
rm(PMID_form_un, PMID_form_deux, PMID_form_trois, PMID_form_quatre, PMID_form_cinq)
